...
languages = {
    ...
    "typescript": {
        ...
        "single_line_blocks": [
            ...
            {"name": "string", "start": "\"", "end": "\""},
            {"name": "string", "start": "'", "end": "'"},
            {"name": "template literal", "start": "`", "end": "`"}
        ],
        "multi_line_blocks": [
            {"name": "multi-line comment", "start": "/*", "end": "*/"}
        ],
    ...
    "perl": {
        ...
        "tokens": [
            ...
            {"name": "hex number", "pattern": "\\b0[xX][0-9a-fA-F]+\\b"},
            {"name": "octal number", "pattern": "\\b0[0-7]+\\b"},
            {"name": "scalar", "pattern": "\\$[a-zA-Z_][a-zA-Z0-9_]*"},
            {"name": "array", "pattern": "@[a-zA-Z_][a-zA-Z0-9_]*"},
            {"name": "hash", "pattern": "%[a-zA-Z_][a-zA-Z0-9_]*"},
            {"name": "glob", "pattern": "\\*[a-zA-Z_][a-zA-Z0-9_]*"}
        ]
    },
    ...
    "objectivec": {
        ...
        "keywords": {
            "keyword": [
                ...
                "dynamic", "optional", "required", "encode", "defs", "selector", "protocol"
            ],
            "type": [
